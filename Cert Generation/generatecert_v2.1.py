...
def generate_req_conf(entries):
    ...
    country, state, locality, organization, organization_unit = entries[0]
    ...
    for entry in entries[1:]:  # Start from the second entry onwards
        ...
        with open(filename, "w") as conf_file:
            ...
            conf_file.write("default_md = sha256\n")
            ...
            conf_file.write(f"organizationalUnitName = {organization_unit}\n")
